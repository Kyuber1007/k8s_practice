    ...
    public class MySqlResultData : IResultData
    {
        ...
        public ResultsModel GetResults()
        {
            ...
            {                
                ...
                if (results.Any(x => x.vote == "c"))
                {
                    model.OptionC = (int) results.First(x => x.vote == "c").count;
                }                
                if (results.Any(x => x.vote == "d"))
                {
                    model.OptionD = (int) results.First(x => x.vote == "d").count;
                }
                model.VoteCount = model.OptionA + model.OptionB + model.OptionC + model.OptionD;
            }
            return model;
        }
    }
